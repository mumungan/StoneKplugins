...
namespace Turbo.Plugins.Stone
{
    public class StarpactBuffSnapShotPlugin : BasePlugin, IInGameWorldPainter
    {
		...
		private int blackHolesb = 0, blackHole = 0, waveOfForcesb = 0, waveOfForce = 0, arcaneDynamosb = 0, arcaneDynamo = 0;
		private float resourcesb = 0, resource = 0;
        ...
        public override void Load(IController hud)
        {
            ...
            StackFont = Hud.Render.CreateFont("tahoma", 18, 255, 255, 255, 255, false, false, 255, 0, 0, 0, true);
                        ...
                        case (ActorSnoEnum)217142:
                            if (Hud.Game.Me.HeroClassDefinition.HeroClass == HeroClass.Wizard)
                            {
                                ...
                                if (Hud.Game.Me.HeroClassDefinition.HeroClass == HeroClass.Wizard && sbremaining > 0)
                                {
									...
									{
										if (me.Powers.BuffIsActive(430674, 1)) coe = "ºñ";
										else if (me.Powers.BuffIsActive(430674, 2)) coe = "³Ã";
										else if (me.Powers.BuffIsActive(430674, 3)) coe = "È­";
										else if (me.Powers.BuffIsActive(430674, 5)) coe = "¹ø";
										else coe = "";
										break;
									}
									break;
